...
(use-package smart-dash
  ...
  :config
  (defun smart-dash-enable ()
    "Enable `smart-dash-mode'."
    (smart-dash-mode)))
#+end_src
...
('editorconfig-conf-mode-hook #'smart-dash-enable)
#+end_src
...
#+begin_src emacs-lisp :noweb-ref smart-dash/ghook
('terraform-mode-hook #'smart-dash-enable)
#+end_src
...
(defconst python-major-modes
  '(inferior-python-mode python-mode python-ts-mode)
...
(python-major-mode-hooks #'smart-dash-enable)
#+end_src
...
#+begin_src emacs-lisp :noweb-ref smart-dash/ghook
('ruby-mode-hook #'smart-dash-enable)
('inf-ruby-mode-hook #'smart-dash-enable)
#+end_src
...
#+begin_src emacs-lisp :noweb-ref smart-dash/ghook
('rust-mode-hook #'smart-dash-enable)
#+end_src
...
#+begin_src emacs-lisp :noweb-ref smart-dash/ghook
('(sql-interactive-mode-hook sql-mode-hook) #'smart-dash-enable)
#+end_src
...
#+begin_src emacs-lisp :noweb-ref smart-dash/ghook
('compilation-mode-hook #'smart-dash-enable)
#+end_src
