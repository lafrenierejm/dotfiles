...
/Directories/ provides platform-specific paths for configuration, cache, and other data.
#+begin_src emacs-lisp
(use-package directories
  :straight (:type git :host github :repo "lafrenierejm/directories-elisp")
  :demand)
#+end_src
...
(use-package no-littering
  ...
  :init
  (setq
   no-littering-etc-directory (directories-project-config "org" "gnu" "emacs")
   no-littering-var-directory (directories-project-data-local "org" "gnu" "emacs")))
#+end_src
...
(use-package emms-source-file
  :after directories
  :custom
  (emms-source-file-default-directory (directories-user-audio)))
#+end_src
