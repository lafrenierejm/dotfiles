...
#+begin_src emacs-lisp :noweb-ref emms/custom
...
#+begin_src emacs-lisp :noweb-ref emms/config
...
#+begin_src emacs-lisp :noweb-ref emms/config
(when (boundp 'minibuffer-line-left)
  (add-to-list 'minibuffer-line-left #'emms-mode-line-playlist-current))
#+end_src

*** Display Playing Time in Minibuffer
...
(use-package python-black
  ;; Load this package after the following packages.
  :ghook
  ('(python-mode-hook python-ts-mode-hook) #'python-black-on-save-mode)
...
(use-package groovy-mode
  ...
  (("\\.gdsl\\'" . groovy-mode)
   ...
   ("/[Jj]enkins\\(?:file\\)?\\(?:\\.[^z-a]+\\)?\\'" . groovy-mode))
