...
(use-package indent-bars-ts
  ...
  :ghook
  ('json-ts-mode-hook #'indent-bars-ts/lafrenierejm/json-indent)
  ...
  :config
  (defun indent-bars-ts/lafrenierejm/json-indent ()
    "Sync `indent-bars-spacing' with JSON indent offset."

    (setq-local indent-bars-spacing-override json-ts-indent-offset)))
#+end_src
